        ...
        <div id="thermal-receipt" className="hidden print:block bg-white text-black font-mono">
          <div className="w-full text-center">
            ...
            <h3 className="text-[10px] font-bold uppercase mb-2">
              {lastTransaction?.isTagOnly ? 'LABEL PENANDA PESANAN' : 'STRUK PEMBAYARAN'}
            </h3>
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-between text-[9px]">
                ...
                <span className="font-bold uppercase">{lastTransaction?.customerName}</span>
              </div>
              <div className="flex justify-between text-[9px]">
                <span className="font-bold">ALM:</span>
                <span className="text-right truncate max-w-[120px]">{lastTransaction?.customerAddress}</span>
              </div>
            </div>
